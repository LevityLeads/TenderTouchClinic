        ...
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-neutral-700">
              Schedule your visit online at a time that suits you. Browse our
              available services and choose the appointment that best fits your
              needs.
            </p>
          </div>
        </Container>
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-3">
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  Choose from antenatal classes, baby massage, postnatal
                  support, and more.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  View available slots and select a date and time that works for
                  you.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  Enter your contact information and receive a confirmation
                  email.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 rounded-lg border border-neutral-200 bg-neutral-50 p-6">
              ...
              <ul className="mt-3 space-y-2 text-sm text-neutral-600">
                ...
                <li className="flex items-start gap-2">
                  ...
                  For antenatal classes: your expected due date
                </li>
                <li className="flex items-start gap-2">
                  <svg
                    className="mt-0.5 h-4 w-4 flex-shrink-0 text-primary-600"
                  ...
                  For baby massage: your baby&apos;s age (6 weeks to pre-crawling)
                </li>
              </ul>
            </div>
        ...
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-neutral-600">
              No problem! Contact us directly and we will help you find a
